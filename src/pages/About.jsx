      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 relative">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 uppercase">Our Team</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Meet the passionate educators and technologists behind Ophyrs
            </p>
            <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-48 h-1 bg-primary-600"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white shadow-lg overflow-hidden group">
              <div className="relative overflow-hidden">
                <img 
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src = "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80";
                  }}
                />
                <div className="absolute inset-0 bg-primary-600 bg-opacity-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-1">Alex Johnson</h3>
                <p className="text-accent-500 mb-4">Founder & CEO</p>
                <p className="text-gray-600 mb-4">Former educator with 15+ years of experience in educational technology and curriculum development.</p>
                <div className="flex gap-3">
                  <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors">LI</a>
                  <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors">TW</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow-lg overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <p className="text-accent-500 mb-4">CTO</p>
                <p className="text-gray-600 mb-4">AI specialist with a background in educational software development and learning analytics.</p>
                <div className="flex gap-3">
                  <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors">LI</a>
                  <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors">TW</a>
                </div>
            ...
            <div className="bg-white shadow-lg overflow-hidden group">
              <div className="relative overflow-hidden">
                <img 
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src = "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80";
                  }}
                />
                <div className="absolute inset-0 bg-primary-600 bg-opacity-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <div className="p-6">
                ...
                <p className="text-accent-500 mb-4">Head of Curriculum</p>
                <p className="text-gray-600 mb-4">Educational psychologist specializing in interactive learning methodologies and assessment design.</p>
                <div className="flex gap-3">
                  <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors">LI</a>
                  <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors">TW</a>
                </div>
            ...
            <div className="bg-white shadow-lg overflow-hidden group">
              <div className="relative overflow-hidden">
                <img 
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src = "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=761&q=80";
                  }}
                />
                <div className="absolute inset-0 bg-primary-600 bg-opacity-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-1">Emily Taylor</h3>
                <p className="text-accent-500 mb-4">UX Director</p>
                <p className="text-gray-600 mb-4">User experience expert focused on creating intuitive, accessible educational interfaces for diverse learners.</p>
                <div className="flex gap-3">
                  <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors">LI</a>
                  <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors">TW</a>
                </div>
